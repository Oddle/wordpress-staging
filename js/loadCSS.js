...
if(window.location.host.includes('localhost')) {
  ...
  loadCSS( "//" + window.location.host + "/wp-content/themes/wordpresscustom/css/bootstrap.min.css" );
  loadCSS( "//" + window.location.host + "/wp-content/themes/wordpresscustom/css/blog.css" );
}
